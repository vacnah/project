/* Adriver CatFish flash+HTML code. Edited svetlana 22.09.2015. Last edited A.Pozdnyakova 27.02.2017 for ticket #48577 */

var ar_img_name = '1.jpg',
    ar_html = 'index.html',
    ar_swf = '',
    ar_width = '100%',
    ar_height = '120',
    ...
    a.onDomReady(function(){
        ...
        a.reposition = function(){
            ...
            if(window.attachEvent){
                s.top = (window.innerHeight+g.st - ar_height) + "px";
                s.left = ((ar_width.substring(ar_width.length-1)!='%')?((g.cw+g.sl)/2 - (ar_width/2)):0) + "px";
            }else{
                s.top = (window.innerHeight - ar_height) + "px";
